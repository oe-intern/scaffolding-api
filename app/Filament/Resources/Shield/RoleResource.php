...
class RoleResource extends Resource implements HasShieldPermissions
{
    ...
    /**
     * Check if the navigation should be registered.
     *
     * @return bool
     */
    ...
    /**
     * Get resource permission descriptions.
     *
     * @param array $entity
     * @return array
     */
    ...
    {
        $resourceFQCN = $entity['fqcn'];

        if (Utils::doesResourceHaveCustomPermissions($resourceFQCN)) {
            if (!method_exists($resourceFQCN, 'getPermissionDescriptions')) {
                return [];
            }

            return collect($resourceFQCN::getPermissionDescriptions())
                ->mapWithKeys(function ($permission, $key) use ($entity) {
                    $name = $key . '_' . $entity['resource'];
    ...
    /**
     * Get resource permission options.
     *
     * @param array $entity
     * @return array
     */
    ...
    /**
     * Get Tab form component for resources.
     *
     * @return Component
     */
    ...
    /**
     * Get checkbox list form component for resource.
     *
     * @param array $entity
     * @return Component
     */
    public static function getCheckBoxListComponentForResource(array $entity): Component
    {
        ...
        $permissionsDescription = static::getResourcePermissionDescriptions($entity);

        return static::getCheckboxListFormComponent($entity['resource'], $permissionsArray, false, $permissionsDescription);
    }

    /**
     * Get tab form component for pages.
     *
     * @return Component
     */
    ...
    /**
     * Get tab form component for widgets.
     *
     * @return Component
     */
    ...
    /**
     * Get tab form component for custom permissions.
     *
     * @return Component
     */
    ...
    /**
     * Get tab form component for simple resource permissions view.
     *
     * @return Component
     */
    ...
    /**
     * Get checkbox list form component.
     *
     * @param string $name
     * @param array $options
     ...
     * @return Component
     */
    public static function getCheckboxListFormComponent(string $name, array $options, bool $searchable = true, array $descriptions = []): Component
    {
        return Forms\Components\CheckboxList::make($name)
            ...
            ->gridDirection('row')
            ->columns(static::getCheckboxListColumns())
     ...
     * @inheritdoc
     */
    public static function getCheckboxListColumns(): int | string | array
    {
        return [
            'sm' => 2,
            'lg' => 2,
