...
return [
    ...
    */
    ...
    'webhooks' => [
         [
             ...
             'address' => env('SHOPIFY_WEBHOOK_ENDPOINT', env('APP_URL')) . '/webhooks/app-uninstalled',
         ],
         [
             'topic' => 'ORDERS_CREATE',
             'address' => env('SHOPIFY_WEBHOOK_ENDPOINT', env('APP_URL')) . '/webhooks/orders-create',
         ],
    ],
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Shopify custom data config
    |--------------------------------------------------------------------------
    */
    'custom_data' => [
        'metafields' => [
            'namespace' => env('METAFIELD_NAMESPACE', 'wacko'),
            'option_set_reference_key' => 'option_set_ref',
            'config' => 'configuration',
        ],
        'metaobjects' => [
            'option_set_type' => '$app:option-set',
        ],
    ],
];
